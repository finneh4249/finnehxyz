...
export const projects: Project[] = [
  ...
  {
    title: "Nexus",
    description: "Shared expense tracker and savings planner for couples — split costs, set joint goals, and sync budgets without linking bank accounts.",
    detailedDescription:
  ...
  },
  {
    title: "PokerBo",
    description:
      "Poker meets Sicbo in the browser — vanilla JavaScript card game with custom betting logic, state management, and a live playable demo.",
    detailedDescription:
  ...
  },
  {
    title: "City Loopers",
    description:
      "Minecraft city-building server with custom plugins, Discord integration, and a greylisted community of urban builders.",
    detailedDescription:
  ...
  },
  {
    ...
    description:
      "Python CLI for querying historical F1 race results, driver standings, and constructor stats from a local SQLite database.",
    detailedDescription:
  ...
  },
  {
    title: "WeatherWise",
    description:
      "Hackathon weather app — real-time conditions and multi-day forecasts via external API, responsive across mobile and desktop.",
    detailedDescription:
  ...
  },
  {
    ...
    description: "Full-stack ordering platform for a real açaí shop — custom menu management, topping selection, and checkout flow.",
    detailedDescription:
